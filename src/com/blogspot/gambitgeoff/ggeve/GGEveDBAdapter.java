...
public class GGEveDBAdapter {
	...
	public long insertEveCharacter(EveCharacter inEveCharacter)
	{
	...
	public boolean removeEveCharacter(long inRowIndex)
	{
	...
	{
		Cursor cursor = myDb.query(DATABASE_TABLE, null, KEY_ID + "=" + inRowIndex, null, null, null, null, null);
		if ((cursor.getCount() == 0) || !cursor.moveToFirst()) {
			  throw new SQLException("Eve Character does not exist for row: " + inRowIndex);
			}
	...
	public int updateEveCharacter(long inRowIndex, EveCharacter inEveCharacter)
	{
