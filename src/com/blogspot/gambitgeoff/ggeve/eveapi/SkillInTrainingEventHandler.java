 ...
 *−
<eveapi version="2">
<currentTime>2009-05-21 12:48:16</currentTime>
−
<result>
<currentTQTime offset="0">2009-05-21 12:48:16</currentTQTime>
<trainingEndTime>2009-05-27 15:27:48</trainingEndTime>
<trainingStartTime>2009-05-20 03:34:12</trainingStartTime>
<trainingTypeID>22807</trainingTypeID>
...
<cachedUntil>2009-05-21 13:48:16</cachedUntil>
</eveapi>
 *
 */
public class SkillInTrainingEventHandler extends DefaultHandler {
	...
	public void characters(char ch[], int start, int length) {
		...
		case CURRENT_TAG_CACHED_UNTIL: {
			myTrainingInformation.setCachedUntil(myEveDateFormat.parse(string)); //parse string
			myCurrentState = -1;
			break;
		}
